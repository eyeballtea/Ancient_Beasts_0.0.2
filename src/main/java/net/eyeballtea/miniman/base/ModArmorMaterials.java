package net.eyeballtea.miniman.base;
...
public enum ModArmorMaterials implements ArmorMaterial {
    EXOSKELETON_BIT("exoskeleton_bit", 28, new int[]{2, 5, 8, 3}, 19, SoundEvents.ARMOR_EQUIP_GOLD,
            2.0F, 0.0F, () -> Ingredient.of(ItemInit.EXOSKELETON_BIT.get()));
    ...
    public String getName() {
        return MiniMan.MODID + ":" + this.name;
    }
